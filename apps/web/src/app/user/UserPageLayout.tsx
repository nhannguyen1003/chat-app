...
const UserPageLayout: FC<{ children: ReactNode }> = ({ children }) => {
  ...
  return (
    <div
      className="bg-whatsapp-light-bg dark:bg-whatsapp-dark-bg relative flex h-screen w-full place-items-center justify-center overflow-hidden"
      style={{ userSelect: isOpen ? 'none' : 'auto' }}
    >
